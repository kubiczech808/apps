...
def prepare():
    ...
    try:
        ...
        upload(ftp, "server-current/getTicker.php", f".codex-backups/btcdca-auth/{BACKUP_ID}/getTicker.php")
...
def upload_deploy():
    ...
    try:
        ...
        upload(ftp, "deploy-root/www/php/getTicker.php", "www/php/getTicker.php")
