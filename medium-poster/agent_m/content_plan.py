...
CONTENT_PLAN: list[ContentPlan] = [
    ...
    # === DRAFT-DERIVED TOPIC BACKLOG ===
    # Imported from old Medium drafts on 2026-06-20. The old drafts themselves
    # are intentionally not scheduled or reused because several were short,
    # malformed, or missing images/links. These entries preserve only the topics.
    ContentPlan(
        slug="bitcoin-dca-cash-drag",
        title_hint="Managing Cash Drag in a Bitcoin DCA Strategy",
        pillar="strategy",
        funnel_stage="consideration",
        seo_keyword="bitcoin dca cash drag",
        tags=["Bitcoin", "DCA", "Cash Management"],
        angle="Show how much fiat reserve is useful for DCA without letting idle cash erode purchasing power.",
        key_points=[
            "Define cash drag for an individual Bitcoin accumulator",
            "Explain the tradeoff between emergency reserves and investable cash",
            "Show a simple reserve rule based on monthly expenses and DCA size",
            "Warn against keeping too much cash on exchanges",
            "Mention btc-dca.com as a way to automate the active DCA portion",
        ],
        cta_target="DCA calculator - model how different cash buffers affect long-term accumulation",
    ),
    ContentPlan(
        slug="bitcoin-dca-inheritance-strategy",
        title_hint="The Bitcoin DCA Inheritance Strategy: Building a Programmatic Legacy",
        pillar="advanced",
        funnel_stage="awareness",
        seo_keyword="bitcoin dca inheritance strategy",
        tags=["Bitcoin", "DCA", "Self Custody"],
        angle="Turn the broken legacy draft into a clean article about automated accumulation plus practical inheritance planning.",
        key_points=[
            "Explain why recurring Bitcoin buys can become a long-term family asset",
            "Separate investment automation from custody and legal planning",
            "Discuss hardware wallets, recovery documentation, and access instructions",
            "Avoid legal advice; recommend professional estate guidance",
            "Connect btc-dca.com automation to the accumulation side of the plan",
        ],
        cta_target="Homepage - automate accumulation while keeping custody planning separate",
    ),
    ContentPlan(
        slug="bitcoin-dca-lifestyle-creep",
        title_hint="Why I Use Bitcoin DCA to Beat Lifestyle Creep",
        pillar="psychology",
        funnel_stage="awareness",
        seo_keyword="bitcoin dca lifestyle creep",
        tags=["Bitcoin", "DCA", "Personal Finance"],
        angle="A behavioral finance story about routing raises into automated Bitcoin accumulation before spending expands.",
        key_points=[
            "Define lifestyle creep with a concrete paycheck example",
            "Show how automatic DCA acts like a savings constraint",
            "Explain why manual saving fails when money stays visible",
            "Give a simple raise-allocation rule",
            "Mention btc-dca.com as the set-and-forget automation layer",
        ],
        cta_target="Registration - turn raises into automatic DCA before lifestyle creep absorbs them",
    ),
    ContentPlan(
        slug="bitcoin-dca-stress-test",
        title_hint="How to Survive a Bear Market With a Bitcoin DCA Stress Test",
        pillar="strategy",
        funnel_stage="consideration",
        seo_keyword="bitcoin dca stress test",
        tags=["Bitcoin", "Bear Market", "DCA"],
        angle="Make DCA survivability practical by stress testing cash flow, drawdowns, and forced-selling risk.",
        key_points=[
            "Explain why conviction alone is not a risk plan",
            "Define a survivability ratio for monthly DCA versus emergency cash",
            "Show what happens during a 50-70% drawdown",
            "Recommend reducing DCA before risking forced selling",
            "Use btc-dca.com calculator as the scenario planning link",
        ],
        cta_target="DCA calculator - stress test different DCA amounts before a bear market",
    ),
    ContentPlan(
        slug="direct-payroll-bitcoin-dca",
        title_hint="Bypassing the Checking Account: How to Set Up Direct Payroll Bitcoin DCA",
        pillar="howto",
        funnel_stage="conversion",
        seo_keyword="direct payroll bitcoin dca",
        tags=["Bitcoin", "DCA", "Automation"],
        angle="Show how payroll-based allocation reduces spending temptation and makes DCA more reliable.",
        key_points=[
            "Explain the pay-yourself-first principle",
            "Show direct deposit split options and manual alternatives",
            "Cover exchange funding, recurring buys, and withdrawal thresholds",
            "Warn about emergency cash and payroll timing risks",
            "Position btc-dca.com as the automation tool after funds arrive",
        ],
        cta_target="Registration - automate the buy and withdrawal side of a payroll DCA setup",
    ),
    ContentPlan(
        slug="multi-cycle-bitcoin-dca",
        title_hint="The Multi-Cycle Bitcoin DCA: Calibrating Buy Frequency to Your Time Horizon",
        pillar="advanced",
        funnel_stage="consideration",
        seo_keyword="multi-cycle bitcoin dca",
        tags=["Bitcoin", "DCA", "Halving"],
        angle="Explain why a 10-year accumulator should not optimize the same way as a 12-month trader.",
        key_points=[
            "Contrast short, medium, and multi-cycle Bitcoin time horizons",
            "Explain how buy frequency matters less as horizon increases",
            "Discuss fees, UTXO management, and cash-flow stability",
            "Suggest a simple frequency matrix by income cadence",
            "Link to btc-dca.com calculator for time-horizon modeling",
        ],
        cta_target="DCA calculator - compare DCA horizons and frequencies",
    ),
    ContentPlan(
        slug="bitcoin-dca-maturity-model",
        title_hint="The Bitcoin DCA Maturity Model: From Manual Buys to Sovereign Infrastructure",
        pillar="advanced",
        funnel_stage="conversion",
        seo_keyword="bitcoin dca maturity model",
        tags=["Bitcoin", "DCA", "Self Custody"],
        angle="Create a practical maturity ladder from manual exchange buys to automated buying and self-custody.",
        key_points=[
            "Stage 1: manual buys and emotional timing",
            "Stage 2: recurring buys on an exchange",
            "Stage 3: automated withdrawals to hardware wallet",
            "Stage 4: rules, tracking, and multi-goal infrastructure",
            "Use btc-dca.com as the bridge from stage 2 to stage 4",
        ],
        cta_target="Features page - show automation, tracking, and withdrawals as maturity steps",
    ),
    ContentPlan(
        slug="bitcoin-dca-exchange-spread-audit",
        title_hint="The Hidden Cost of Convenience: How Exchange Spreads Devour Bitcoin DCA",
        pillar="howto",
        funnel_stage="consideration",
        seo_keyword="bitcoin dca exchange spread",
        tags=["Bitcoin", "DCA", "Fees"],
        angle="Help readers audit the real cost of easy-buy buttons, spreads, and recurring purchase fees.",
        key_points=[
            "Explain spread versus explicit trading fee",
            "Show how 1% hidden spread compounds across weekly DCA",
            "Give a quick audit method using order history",
            "Compare market buy, limit buy, and recurring buy flows",
            "Mention btc-dca.com as a way to standardize execution rules",
        ],
        cta_target="DCA calculator - compare returns after fee and spread assumptions",
    ),
    ContentPlan(
        slug="bitcoin-dca-tax-optimization-tracking",
        title_hint="Why Bitcoin DCA Needs Tax Optimization and Portfolio Tracking",
        pillar="howto",
        funnel_stage="consideration",
        seo_keyword="bitcoin dca tax optimization",
        tags=["Bitcoin", "DCA", "Taxes"],
        angle="Explain why recurring buys create many tax lots and why tracking should start before selling.",
        key_points=[
            "Explain cost basis and why DCA creates many lots",
            "Show common CSV and exchange-history problems",
            "Discuss tax-loss harvesting only at a high level",
            "Recommend keeping clean records from day one",
            "Connect btc-dca.com tracking to disciplined accumulation",
        ],
        cta_target="DCA calculator - plan accumulation with cleaner long-term tracking",
    ),
    ContentPlan(
        slug="automate-multisig-bitcoin-dca",
        title_hint="How to Automate a Multisig Bitcoin DCA Setup",
        pillar="advanced",
        funnel_stage="conversion",
        seo_keyword="multisig bitcoin dca",
        tags=["Bitcoin", "Multisig", "DCA"],
        angle="Explain when multisig makes sense and how automation can feed collaborative custody without adding chaos.",
        key_points=[
            "Define multisig in plain language",
            "Explain who actually needs multisig versus a hardware wallet",
            "Cover withdrawal thresholds, address verification, and operational discipline",
            "Warn about complexity and backup procedures",
            "Mention btc-dca.com for automated accumulation before custody routing",
        ],
        cta_target="Features page - automate purchases while keeping custody policy disciplined",
    ),
    ContentPlan(
        slug="reverse-bitcoin-dca-profit-taking",
        title_hint="The Reverse DCA: How to Take Bitcoin Profits Without Emotional Regret",
        pillar="strategy",
        funnel_stage="consideration",
        seo_keyword="reverse bitcoin dca",
        tags=["Bitcoin", "DCA", "Profit Taking"],
        angle="Turn profit-taking into a systematic rule instead of an all-or-nothing emotional decision.",
        key_points=[
            "Explain reverse DCA as scheduled or threshold-based selling",
            "Contrast it with panic selling and top calling",
            "Show examples based on portfolio percentage or life goals",
            "Recommend keeping a core long-term position",
            "Connect btc-dca.com goal tracking to exit discipline",
        ],
        cta_target="DCA calculator - model both accumulation and goal milestones",
    ),
    ContentPlan(
        slug="corporate-bitcoin-reserve-dca",
        title_hint="How to Build a Corporate Bitcoin Reserve With Automated Treasury DCA",
        pillar="advanced",
        funnel_stage="conversion",
        seo_keyword="corporate bitcoin reserve dca",
        tags=["Bitcoin", "Treasury", "DCA"],
        angle="A practical small-business treasury article focused on gradual allocation instead of headline-grabbing lump sums.",
        key_points=[
            "Explain why small businesses think about treasury cash drag",
            "Show why DCA is less disruptive than lump-sum treasury allocation",
            "Cover policy, accounting, custody, and approval workflow considerations",
            "Avoid tax/legal advice and point to professional review",
            "Mention btc-dca.com as an automation layer for disciplined treasury buys",
        ],
        cta_target="Homepage - automate recurring Bitcoin purchases for a disciplined treasury process",
    ),
    ContentPlan(
        slug="inflation-proof-bitcoin-dca",
        title_hint="Why Your Static $100 Bitcoin DCA Is Shrinking and How to Inflation-Proof It",
        pillar="strategy",
        funnel_stage="consideration",
        seo_keyword="inflation proof bitcoin dca",
        tags=["Bitcoin", "DCA", "Inflation"],
        angle="Show that a fixed fiat contribution slowly becomes a smaller real investment unless it is adjusted.",
        key_points=[
            "Explain nominal versus real DCA contribution size",
            "Show how inflation reduces the power of a fixed weekly buy",
            "Suggest annual contribution reviews or income-linked rules",
            "Warn against over-adjusting beyond cash-flow safety",
            "Use btc-dca.com calculator to compare static versus growing DCA amounts",
        ],
        cta_target="DCA calculator - compare static and inflation-adjusted DCA plans",
    ),
    ContentPlan(
        slug="dynamic-bitcoin-dca-fear-greed",
        title_hint="The Dynamic Bitcoin DCA: How to Adjust Buys on Fear and Greed",
        pillar="advanced",
        funnel_stage="consideration",
        seo_keyword="dynamic bitcoin dca fear greed",
        tags=["Bitcoin", "DCA", "Fear And Greed"],
        angle="Explain a rules-based version of buying more during fear without turning DCA into emotional trading.",
        key_points=[
            "Define dynamic DCA and how it differs from market timing",
            "Use fear and greed as an example signal, not a magic predictor",
            "Show a simple multiplier framework with caps",
            "Discuss risks of overfitting and running out of cash",
            "Mention btc-dca.com automation as the baseline system",
        ],
        cta_target="DCA calculator - test baseline DCA before adding dynamic rules",
    ),
    ContentPlan(
        slug="utxo-optimized-bitcoin-dca",
        title_hint="The UTXO-Optimized DCA: Accumulate Bitcoin Without Future Fee Pain",
        pillar="howto",
        funnel_stage="consideration",
        seo_keyword="utxo optimized bitcoin dca",
        tags=["Bitcoin", "UTXO", "DCA"],
        angle="Teach why tiny withdrawals can become expensive later and how to set practical consolidation rules.",
        key_points=[
            "Explain UTXOs with a plain-language wallet analogy",
            "Show why weekly tiny withdrawals can create future fee problems",
            "Recommend withdrawal thresholds and consolidation windows",
            "Balance self-custody urgency with operational efficiency",
            "Mention btc-dca.com withdrawal automation as a rules-based solution",
        ],
        cta_target="Features page - automate withdrawals with sensible thresholds",
    ),
    ContentPlan(
        slug="buy-bitcoin-at-all-time-highs",
        title_hint="Why I Buy Bitcoin at All-Time Highs",
        pillar="psychology",
        funnel_stage="awareness",
        seo_keyword="buy bitcoin at all time highs",
        tags=["Bitcoin", "DCA", "Mindset"],
        angle="Use all-time-high anxiety as a hook for explaining why waiting for perfect dips often backfires.",
        key_points=[
            "Explain the psychological resistance to buying new highs",
            "Show the math of waiting for a dip after price discovery",
            "Compare DCA versus paused buying during bull markets",
            "Include a sober risk disclaimer about volatility",
            "Link to btc-dca.com calculator for scenario testing",
        ],
        cta_target="DCA calculator - test buying through all-time highs versus waiting",
    ),
    ContentPlan(
        slug="post-halving-sideways-grind-dca",
        title_hint="Surviving the Post-Halving Sideways Grind With Bitcoin DCA",
        pillar="strategy",
        funnel_stage="awareness",
        seo_keyword="post halving bitcoin dca",
        tags=["Bitcoin", "Halving", "DCA"],
        angle="Explain why boredom after a halving can be more dangerous than a crash for long-term accumulators.",
        key_points=[
            "Explain the post-halving lag between narrative and price action",
            "Show why sideways markets test patience",
            "Use DCA as a boredom-resistant accumulation rule",
            "Warn against abandoning Bitcoin for short-lived narratives",
            "Mention btc-dca.com as the tool that keeps the plan running quietly",
        ],
        cta_target="Homepage - automate DCA through boring sideways markets",
    ),
]
