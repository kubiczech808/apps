...
const getContractConfig = (chainID) => {
	switch (chainID) {
		case 137: return MATIC_CONTRACTS;
		case 80002: return AMOY_CONTRACTS;
		default: throw new Error("Invalid network");
	}
};

//#endregion
exports.COLLATERAL_TOKEN_DECIMALS = COLLATERAL_TOKEN_DECIMALS;
exports.CONDITIONAL_TOKEN_DECIMALS = CONDITIONAL_TOKEN_DECIMALS;
