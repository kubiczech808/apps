import { ClobSigner } from "./signing/signer.js";
import { Side } from "./order-utils/model/side.js";
import { ApiKeyCreds, ApiKeysResponse, BalanceAllowanceParams, BalanceAllowanceResponse, BanStatus, BookParams, BuilderApiKey, BuilderApiKeyResponse, BuilderConfig, BuilderFeeRates, BuilderTradeParams, BuilderTradesResponse, Chain, CreateOrderOptions, DropNotificationParams, FeeInfos, FeeRates, MarketDetails, MarketPrice, MarketReward, MarketTradeEvent, NegRisk, Notification, OpenOrder, OpenOrderParams, OpenOrdersResponse, OrderBookSummary, OrderMarketCancelParams, OrderPayload, OrderResponse, OrderScoring, OrderScoringParams, OrderType, OrdersScoring, OrdersScoringParams, PaginationPayload, PreMigrationOrdersResponse, PriceHistoryFilterParams, ReadonlyApiKeyResponse, RewardsPercentages, TickSize, TickSizes, TotalUserEarning, Trade, TradeParams, TradesPaginatedResponse, UserEarning, UserRewardsEarning } from "./types/clob.js";
import { UserMarketOrderV1, UserOrderV1 } from "./types/ordersV1.js";
import { UserMarketOrderV2, UserOrderV2 } from "./types/ordersV2.js";
import { ExchangeV3OrderAmounts } from "./types/ordersV3.js";
import { PostOrdersArgs, SignedOrder } from "./types/unifiedOrder.js";
...
import "./order-builder/index.js";
import { adjustBuyAmountForFees } from "./fees/index.js";
...
declare class ClobClient {
  ...
  createExchangeV3OrderFromAmounts(userOrder: ExchangeV3OrderAmounts): Promise<SignedOrder>;
  createAndPostOrder<T extends OrderType.GTC | OrderType.GTD = OrderType.GTC>(userOrder: UserOrderV1 | UserOrderV2, options?: Partial<CreateOrderOptions>, orderType?: T, postOnly?: boolean, deferExec?: boolean): Promise<OrderResponse>;
  createAndPostMarketOrder<T extends OrderType.FOK | OrderType.FAK = OrderType.FOK>(userMarketOrder: UserMarketOrderV1 | UserMarketOrderV2, options?: Partial<CreateOrderOptions>, orderType?: T, deferExec?: boolean): Promise<OrderResponse>;
  ...
  private waitForResolvedTrades;
  private resolveTransactionsHashes;
...
//#endregion
export { ClobClient, ClobClientOptions };
