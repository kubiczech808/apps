...
const require_createExchangeV3OrderFromAmounts = require('./helpers/createExchangeV3OrderFromAmounts.cjs');
...
var OrderBuilder = class {
	...
	*/
	async buildExchangeV3OrderFromAmounts(userOrder) {
		return require_createExchangeV3OrderFromAmounts.createExchangeV3OrderFromAmounts(await this.resolveSigner(), this.chainId, this.signatureType, this.funderAddress, userOrder);
	}
