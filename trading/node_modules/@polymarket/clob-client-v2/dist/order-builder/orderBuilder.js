...
import { createMarketOrder } from "./helpers/createMarketOrder.js";
...
var OrderBuilder = class {
	...
	*/
	...
	constructor(signer, chainId, signatureType, funderAddress, getSigner) {
		...
		this.signatureType = signatureType === void 0 ? SignatureTypeV2.EOA : signatureType;
	...
	*/
	async buildExchangeV3OrderFromAmounts(userOrder) {
		return createExchangeV3OrderFromAmounts(await this.resolveSigner(), this.chainId, this.signatureType, this.funderAddress, userOrder);
	}
