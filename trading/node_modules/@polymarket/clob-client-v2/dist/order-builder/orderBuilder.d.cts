...
import { Chain, CreateOrderOptions } from "../types/clob.cjs";
...
//#region src/order-builder/orderBuilder.d.ts
declare class OrderBuilder {
   ...
   */
  buildExchangeV3OrderFromAmounts(userOrder: ExchangeV3OrderAmounts): Promise<SignedOrderV2>;
  /** Unified getter: use fresh signer if available */
  private resolveSigner;
}
//#endregion
export { OrderBuilder };
//# sourceMappingURL=orderBuilder.d.cts.map