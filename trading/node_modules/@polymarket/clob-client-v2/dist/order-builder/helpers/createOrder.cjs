...
//#region src/order-builder/helpers/createOrder.ts
const createOrder = async (eoaSigner, chainId, signatureType, funderAddress, userOrder, options, version) => {
	...
	const orderData = await require_buildOrderCreationArgs.buildOrderCreationArgs(signerForOrder, maker, signatureType, userOrder, require_roundingConfig.ROUNDING_CONFIG[options.tickSize], version);
...
//# sourceMappingURL=createOrder.cjs.map