    ...
    private function frontend_i18n_data(): array
    {
        ...
        $exact = [
            'en' => [
                ...
                'Great news! Your order has been received, and a confirmation will be sent to your email address.' => 'Great news! Your order has been received, and a confirmation will be sent to your email address.',
                'Have an account with us?' => 'Have an account with us?',
                'Log in here' => 'Log in here',
                'to view your order.' => 'to view your order.',
                'Alternatively, confirm the email address linked to the order below.' => 'Alternatively, confirm the email address linked to the order below.',
            ...
            'de' => [
                ...
                'Great news! Your order has been received, and a confirmation will be sent to your email address.' => 'Gute Nachricht! Ihre Bestellung ist eingegangen und eine Bestätigung wird an Ihre E-Mail-Adresse gesendet.',
                'Have an account with us?' => 'Haben Sie ein Konto bei uns?',
                'Log in here' => 'Hier einloggen',
                'to view your order.' => 'um Ihre Bestellung anzusehen.',
                'Alternatively, confirm the email address linked to the order below.' => 'Alternativ bestätigen Sie unten die mit der Bestellung verknüpfte E-Mail-Adresse.',
                'Email address' => 'E-Mail-Adresse',
                'Order #' => 'Bestellnummer',
                'Order #:' => 'Bestellnummer:',
                'Date' => 'Datum',
            ...
            'pl' => [
                ...
                'Great news! Your order has been received, and a confirmation will be sent to your email address.' => 'Świetna wiadomość! Twoje zamówienie zostało przyjęte, a potwierdzenie zostanie wysłane na Twój adres e-mail.',
                'Have an account with us?' => 'Masz u nas konto?',
                'Log in here' => 'Zaloguj się tutaj',
                'to view your order.' => 'aby zobaczyć swoje zamówienie.',
                'Alternatively, confirm the email address linked to the order below.' => 'Alternatywnie potwierdź poniżej adres e-mail powiązany z zamówieniem.',
                'Email address' => 'Adres e-mail',
